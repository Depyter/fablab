...
export function AddSessionDialog({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const dateTimestamp = getLabDayStartTimestamp(dateObj);
    const startTimestamp = getLabTimeTimestamp(dateObj, startTime);
    const endTimestamp = getLabTimeTimestamp(dateObj, endTime);
