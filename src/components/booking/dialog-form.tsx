  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleOpenChange}>
      <DialogTrigger asChild>
        <Button variant="outline" className="bg-[#1A8A7E] hover:bg-[#156E65] px-10 font-medium rounded-lg text-white hover:text-white w-full">Create Booking</Button>
      </DialogTrigger>
            ...
            <form onSubmit={handleEstimate}>
                ...
                <div className="-mx-4 no-scrollbar max-h-[70vh] overflow-y-auto px-4 py-4">
                  ...
                  <Field>
                    ...
                    <Textarea id="description-1" name="username" defaultValue="" aria-required="true" className="rounded-lg" placeholder="Describe your project, intended use, or anu specific details..."/>
                  </Field>
                  <Field>
