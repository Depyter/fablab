    ...
    <Card className="w-full sm:max-w-2xl border-none bg-color">
      <CardContent className="pt-6">
        ...
        <div className="flex items-center gap-6 mb-8">
          ...
          <Button
            variant="default"
            className="bg-chart-4 text-white hover:bg-gray-800 rounded-md shadow-sm"
          >
            Upload image
          </Button>
        </div>
        ...
        <div className="space-y-2 mb-5">
          ...
          <Input id="email" placeholder="Email@gmail.com" className="w-full" />
        </div>
        <Button
          variant="default"
          className="bg-primary text-white hover:bg-primary-muted hover:text-chart-2 rounded-md shadow-sm font-semibold"
        >
          Save Changes
        </Button>
      </CardContent>
